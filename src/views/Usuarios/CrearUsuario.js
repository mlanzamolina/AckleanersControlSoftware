        ...
        <div className="containerC">
            ...
            <form id="signup" onSubmit={(e)=>add(e.preventDefault())}  >
                ...
                <div class="inputs">
                    ...
                    <input type="email" name="correo" autofocus onChange={(e) => setCorreo(e.target.value)} value={correo} />

                    <h5>Ingrese Contraseña</h5>
                    <input type="password" name="contra" placeholder="Debe contener al menos 6 caracteres"   onChange={(e) => setContra(e.target.value)} value={contra} />

                    <h5>Confirmar Contraseña</h5>
                    <input type="password" name="contra1"  onChange={(e) => setContra1(e.target.value)} value={contra1} />
